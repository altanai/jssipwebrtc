...
gulp.task('clean', async () => del(OUTPUT_DIR, { force: true }));

gulp.task('env:dev', async (done) =>
{
...
gulp.task('resources', async (done) =>
{
...
gulp.task('openbrowser', async(done) =>
{
	browserSync(
		{
			server :
